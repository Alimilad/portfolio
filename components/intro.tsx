...
export default function Intro() {
  const { ref } = useActiveLinkInView("Home",0.5)
  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        ...
        focus is{" "}
        <span className="underline">C# (ASPCore & Blazor)</span>.{" "}
        I am also familar with Python and Nodejs.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ali-salehi/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Alimilad"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
